...
def register_handlers(bot):
    ...
    OPPOSITES = {
        ...
        "غني": "فقير", "طويل": "قصير", "واسع": "ضيق", "سمين": "نحيف",
        "عالي": "منخفض", "قريب": "بعيد", "جديد": "قديم", "سهل": "صعب",
        "نجاح": "فشل", "شجاع": "جبان", "كريم": "بخيل", "صادق": "كاذب",
        "أمانة": "خيانة", "عدل": "ظلم", "تواضع": "تفاخر", "هدوء": "ضجيج",
        "حياة": "موت", "نور": "ظلام", "حق": "باطل", "جنة": "نار",
        "سماء": "أرض", "بحر": "بر", "شرق": "غرب", "شمال": "جنوب",
        "بداية": "نهاية", "أول": "آخر", "صعود": "هبوط", "فوز": "خسارة",
        "بناء": "هدم", "جمع": "طرح", "ضرب": "قسمة", "مدح": "ذم",
        "ثقيل": "خفيف", "ناعم": "خشن", "حلو": "مر", "يابس": "رطب",
        "مملوء": "فارغ", "مفتوح": "مغلق", "نظيف": "متسخ", "ثبات": "حركة",
        "يقظة": "نوم", "ظاهر": "باطن"
    }
